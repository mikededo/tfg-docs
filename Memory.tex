...
\\
As my personal experience, I had few issues with the system used in my gym. Even though I have only experienced one side of the application, as a client, I believe that some parts could be improved, as in anything. For instance, the user experience of such app it is not the best. It has had server issues a couple of times, the interface is not the most intuitive, neither the most goodlooking.  
\section{Motivation}
\section{Purpose}
